...
class InputValidator:
    ...
    def validate_inputs(raw_data: Dict[str, str]) -> Dict[str, float]:
        ...
        try:
            ...
            validated['building_height_m'] = (
                InputValidator.validate_height_range(
                    validated['building_height_m']
                ))

            validated['count_corner'] = (
    ...
    def validate_positive_number(
        value: Any, field_name: str, min_value: float = 0.01) -> float:
    ...
    def validate_positive_integer(
        value: Any, field_name: str, min_value: int = 1) -> int:
